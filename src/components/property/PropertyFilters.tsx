...
import { Search, SlidersHorizontal, X, ChevronDown, Home, MapPin, DollarSign, Bed, User, Menu } from "lucide-react";
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      <div className="bg-white border border-gray-300 rounded-full p-2 shadow-lg hover:shadow-xl transition-shadow">
        <div className="flex items-center gap-2">
          ...
          <motion.div
            whileHover={{ scale: 1.02 }}
            className="flex items-center gap-3 px-3 py-2 border border-gray-300 rounded-full hover:shadow-md transition-all cursor-pointer ml-auto"
          >
